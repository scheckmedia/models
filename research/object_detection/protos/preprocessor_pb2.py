...
_PREPROCESSINGSTEP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_noise', full_name='object_detection.protos.PreprocessingStep.random_noise', index=37,
...
_RANDOMNOISE = _descriptor.Descriptor(
  name='RandomNoise',
  full_name='object_detection.protos.RandomNoise',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_std', full_name='object_detection.protos.RandomNoise.min_std', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_std', full_name='object_detection.protos.RandomNoise.max_std', index=1,
      number=2, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='color', full_name='object_detection.protos.RandomNoise.color', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='force', full_name='object_detection.protos.RandomNoise.force', index=3,
...
_PREPROCESSINGSTEP.fields_by_name['random_noise'].message_type = _RANDOMNOISE
...
_PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step'].fields.append(
  _PREPROCESSINGSTEP.fields_by_name['random_noise'])
_PREPROCESSINGSTEP.fields_by_name['random_noise'].containing_oneof = _PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step']
...
DESCRIPTOR.message_types_by_name['RandomNoise'] = _RANDOMNOISE
...
RandomNoise = _reflection.GeneratedProtocolMessageType('RandomNoise', (_message.Message,), dict(
  DESCRIPTOR = _RANDOMNOISE,
  __module__ = 'object_detection.protos.preprocessor_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.RandomNoise)
  ))
_sym_db.RegisterMessage(RandomNoise)
